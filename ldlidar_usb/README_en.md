# ldlidar_pc Direction Of Use(LD06orLD19)

---

> Directory `ldlidar_pc` contains the SDK that is suitable for the platform without native serial peripheral, such as PC, it requires an extra CP2102 USB to UART bridge to connect LD19 and the upper platform.
>
...
The contents of directory `ldlidar_pc` are listed below:
...
1. Copy folder `ldlidar_pc/src` and `ldlidar_pc/rviz` to certain empty directory A.
